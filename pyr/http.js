...
function redirectURL(requestDetails) {
  ...
  //   };
  // }
  if (settings.wc.qa && settings.wc.paycallback2) {
    ...
    if (url.match(/https\:\/\/rc\.cashier\-qa\.pyr\/paycallback2\/templates\//)) {
  ...
  if (settings.wc.qa) {
    let version = '2.20.1184'; 
    if (url === `https://cdn-qa.pyrsoftware.ca/wc/${version}/cashier.js`) { //'2.20.1303'
      return {
    ...
    if (url === `https://rc.cashier-qa.pyr/cashier/i18n/locales/en.js`) { 
      // https://cdn-qa.pyrsoftware.ca/wc/2.20.1303/i18n/locales/en.js
      return {
        redirectUrl: 'http://localhost:3000/cashier/i18n/locales/en.js'
      };
    }

    if (url === `https://cdn-qa.pyrsoftware.ca/wc/${version}/styles/2015/cashier.css`) { //'2.20.1303'
      return {
